...
- (void)loadView {
    ...
    artworkImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, boundsWindow.safeAreaInsets.top, self.view.bounds.size.width, 315)]; //looks like affects x2 pixels
    ...
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, boundsWindow.safeAreaInsets.top + 315, self.view.bounds.size.width, 50)];
    ...
    downloadPercentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, boundsWindow.safeAreaInsets.top + 315 + titleLabel.frame.size.height, self.view.bounds.size.width, 50)];
